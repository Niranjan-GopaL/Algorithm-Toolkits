...
int  main () 
{
	...
	i = 1;
	while (i < n)i = i * 2; // <-- i is a smallest power of 2 that is greater than n
	k = i; //  i is a smallest power of 2 that is greater than n
	
	// filling last "remnents" with INT_MAX
	while (i > n - 1) {
		A[i] = INT_MAX;
		i--;
	}
