'''
base is a constant prime number used as a base for the calculation of hash values.
MOD is a large prime number used as a modulo to avoid overflow. 
The seed is the initial value of the hash function.
'''
